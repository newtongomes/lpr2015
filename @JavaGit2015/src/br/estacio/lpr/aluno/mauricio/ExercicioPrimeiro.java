...
/*****************************************************************************
 * Exercicio 01 (c) Mauricio Muñoz Lucero, 2015                              *
...
public class ExercicioPrimeiro {
    ...
    final String version = "$VER:Exemplo 01 v1.0";

    public ExercicioPrimeiro () {
    ...
    public static void main (String[] args) {
        ExercicioPrimeiro exemplo = new ExercicioPrimeiro();
    }
}
