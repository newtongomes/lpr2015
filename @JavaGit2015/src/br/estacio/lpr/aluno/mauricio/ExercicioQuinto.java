...
/*****************************************************************************
 * Exercicio 05 (c) Mauricio Muñoz Lucero, 2015                              *
...
public class ExercicioQuinto {
    ...
    final String version = "$VER:Exemplo 05 v1.0";

    public ExercicioQuinto () {
        // Definição das constantes
        ...
        do {
            ...
            if (contadorVencedores > 1)
                System.out.println("Temos mais de um vencedor, repetimos a votação.");
    ...
    public static void main(String[] args) {
        ExercicioQuinto exemplo = new ExercicioQuinto();
    }
}
