...
/*****************************************************************************
 * Exercicio Banco Dados Alunos (c) Mauricio Muñoz Lucero, 2015
...
public class BancoDadosAlunos {

    // Definição das constantes
    final String version = "$VER:Banco Dados Alunos v1.0";
    ...
    // ----------------------------------------------------------------------------
    // Programa principal
    public BancoDadosAlunos () throws ClassNotFoundException {
        int matricula;
        String nome;
        String curso;
        float media;
