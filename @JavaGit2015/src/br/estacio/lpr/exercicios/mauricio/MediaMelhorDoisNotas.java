...
/*****************************************************************************
 * Exercicio Média Melhor Dois Notas (c) Mauricio Muñoz Lucero, 2015                              *
 * Elabore um novo programa para calcular a média do Problema 2, considerando*
 * apenas as duas maiores notas do aluno.                                    *
 *****************************************************************************/

import java.util.Scanner; 	// Entrada de teclado

public class MediaMelhorDoisNotas {

    // Definição das constantes
    final String version = "$VER:Média Melhor Dois Notas v1.0";
    ...
    /*************************************************************************
     * 'converte_nota' é uma função que redondea um número decimal a só uma  * 
    ...
    /*************************************************************************
     * 'procuraMenorNotaAluno' é uma função obtem o indice da menor nota do  * 
     * aluno.                                                                *
     * ENTRADAS:                                                             *
    ...
    /*************************************************************************
     * 'calculaMediaAluno' é um procedimento que calcula a media das notas   *
     * de um aluno.                                                          *
     * ENTRADAS:                                                             *
     *      aluno: Variável com os dados do aluno (referencia)               *
     *************************************************************************/
