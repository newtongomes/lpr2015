...
/*****************************************************************************
 * Exercicio Precipitação Ceará (c) Mauricio Muñoz Lucero, 2015              *
...
public class PrecipitacaoCeara {

    // Definição das constantes
    final String version = "$VER:Precipitação Ceará v1.0";
    ...
    static void armazenaDadosPrecipitacao(boolean aleatorio) {
        if (aleatorio) {
            ...
            for(int i = 0; i < DIAS_ANO; i++) {
                ...
                precipitacaoDiaria2013[i] = formateaNumero(MAX_PLUVIOSIDADE 
                                                                * random.nextFloat());
            ...
            for(int i = 0; i < DIAS_ANO; i++) {
                do {
                    ...
                    System.out.println();
                                ...
                                (precipitacaoDiaria2013[i] > MAX_PLUVIOSIDADE));
            }
        System.out.println();
    }
