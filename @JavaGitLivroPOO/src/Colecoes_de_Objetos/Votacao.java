  ...
  */
  public void tabula()
    ...
    while(votos.size() > 0) // para cada voto recebido...
      ...
      String candidatoVotado = (String)votos.remove(0); // com uma só método !
      ...
      if (candidatos.contains(candidatoVotado))
        ...
        int posição = candidatos.indexOf(candidatoVotado);
        // Recuperamos o número de votos, incrementando este valor e o colocando
        // na lista novamente.
        Integer votosAtéAgora = (Integer)votosPorCandidatos.get(posição);
        votosAtéAgora = new Integer(1+votosAtéAgora.intValue());
  ...
  */ 
  public String toString()
    ...
    for(int c=0;c<candidatos.size();c++) // para cada candidato
      ...
      sb.append(candidatos.get(c)); sb.append(" recebeu "); 
      sb.append(votosPorCandidatos.get(c)); sb.append(" votos\n");
      }
