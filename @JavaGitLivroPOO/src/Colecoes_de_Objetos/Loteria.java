...
class Loteria
  ...
  */
  public static void main(String[] argumentos)
    ...
    for(int i = 0; i < arrayCom10.length; i++) System.out.print(" "+arrayCom10[i]);
    System.out.println();
    // Sorteamos e imprimimos um array com 50 inteiros
    int[] arrayCom50 = sorteiaNúmeros(50);
    for(int i = 0; i < arrayCom50.length; i++) System.out.print(" "+arrayCom50[i]);
    System.out.println();
    }
