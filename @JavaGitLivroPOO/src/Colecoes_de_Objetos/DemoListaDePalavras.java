...
class DemoListaDePalavras
  ...
  */
  public static void main(String[] argumentos)
    ...
    ListaDePalavras palavrasDoMillôr = new ListaDePalavras();
    palavrasDoMillôr.adiciona("Nunca neguei a ninguém o direito de concordar inteiramente comigo.");
    palavrasDoMillôr.adiciona("Democracia é eu mandar em você. Ditadura é você mandar em mim.");
    palavrasDoMillôr.adiciona("Com o desenvolvimento da genética, dentro de alguns anos teremos "+
                              "geneticistas bem melhores do que os atuais.");
    palavrasDoMillôr.adiciona("Quando falamos mentimos muito, porque nossa imaginação é muito "+
