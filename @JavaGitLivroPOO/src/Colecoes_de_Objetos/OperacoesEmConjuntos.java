...
class OperacoesEmConjuntos
  ...
  */
  public static void main(String[] argumentos)
    ...
    solteiros.add("Tom Christiansen");    solteiros.add("Larry Wall");
    // O conjunto de autores casados
    HashSet casados = new HashSet(); 
    casados.add("Nathan Torkington");     casados.add("Jeffrey Friedl");
    casados.add("Randal Schwartz");       casados.add("Sriram Srinivasan");
    // O conjunto de todos os tenistas
    HashSet tenistas = new HashSet();
    tenistas.add("Tom Christiansen");     tenistas.add("Jeffrey Friedl");
    tenistas.add("Larry Wall");
    // O conjunto de todos os nadadores
    HashSet nadadores = new HashSet();
    nadadores.add("Nathan Torkington");   nadadores.add("Sriram Srinivasan"); 
