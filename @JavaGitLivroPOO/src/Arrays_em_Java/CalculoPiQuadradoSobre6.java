...
class CalculoPiQuadradoSobre6
  ...
  */
  public static void main(String[] argumentos)
    ...
    for(int contador=0;contador<termosDaSérie.length;contador++)
      {
      double denominador = contador+1.;
      termosDaSérie[contador] = 1./(denominador*denominador);
      }
  ...
  */
  private static void calculaEMostraSomatória(double[] array,int índiceMáximo)
    {
    double somatória = 0;
    ...
    System.out.println("Índice Máximo:"+índiceMáximo+" Somatória:"+somatória);
    }
