    ...
    public void definirEventos() {
        btMudarCor.addMouseListener(new MouseListener() {
            public void mouseClicked(MouseEvent e) {
                System.out.println("O botao do mouse foi pressionado e solto!");
            }
            public void mousePressed(MouseEvent e) {
                System.out.println("O botao do mouse foi pressionado!");
                tfCaixa1.setBackground(Color.red);
            }
            public void mouseReleased(MouseEvent e) {
                System.out.println("O botao do mouse foi solto!");
            }
